...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 380 -320 0 0 {name=M4
L=0.15
W=1
nf=1
mult=1
...
C {devices/code.sym} 710 -560 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/code_shown.sym} 490 -510 0 0 {name=SPICE only_toplevel=false value=".dc Vgs 0 1.2 0.001
.save all"}
