...
C {devices/vsource.sym} -220 -110 0 0 {name=V2 value="pulse(0 0.6 1u 10n 10n 5m 10m)"}
...
"
spice_ignore=false}
C {devices/code_shown.sym} 520 -560 0 0 {name=SPICE only_toplevel=false value=".tran 5m 50
.save y"}
...
C {devices/vsource.sym} 70 -100 0 0 {name=V3 value=0}
...
C {devices/capa.sym} -330 -310 0 0 {name=C2
m=1
value=100u
footprint=1206
device="ceramic capacitor"}
